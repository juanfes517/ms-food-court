package com.pragma.foodcourt.application.helper.constants;

public class DtoConstants {

    private DtoConstants() {}

    public static final String NAME_CANNOT_BE_BLANK = "The restaurant name cannot be blank";
    public static final String NIT_CANNOT_BE_BLANK = "The restaurant NIT cannot be blank";
    public static final String ADDRESS_CANNOT_BE_BLANK = "The restaurant address cannot be blank";
    public static final String CELL_PHONE_NUMBER_CANNOT_BE_BLANK = "The restaurant cell phone number cannot be blank";
