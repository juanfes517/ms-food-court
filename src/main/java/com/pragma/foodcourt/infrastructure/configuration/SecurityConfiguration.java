    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers(HttpMethod.PATCH, SecurityConstants.getCustomerPatchEndpoints()).hasRole(SecurityConstants.CUSTOMER_ROLE);
                    http.requestMatchers(HttpMethod.GET, SecurityConstants.getEmployeeEndpoints()).hasRole(SecurityConstants.EMPLOYEE_ROLE);
                    http.requestMatchers(HttpMethod.PATCH, SecurityConstants.getEmployeeEndpoints()).hasRole(SecurityConstants.EMPLOYEE_ROLE);
